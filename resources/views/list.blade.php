<div class="flex flex-col gap-2 border-r border-gray-500 border-solid w-[350px]">
    <div class="flex flex-col">
        @foreach($mailables as $mailable)
            ...
            @else
                <a href="{{ route('mailbook.dashboard', ['selected' => $mailable->class]) }}"
                   class="text-white hover:bg-gray-700 group flex items-center px-3 py-2 text-base font-medium">
                    {{ $mailable->name() }}
                </a>
            @endif
        @endforeach
